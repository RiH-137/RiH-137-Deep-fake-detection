...
#     model_name = "EleutherAI/gpt-neo-1.3B"  # Replace with your desired Hugging Face model
...
# # Wrap Hugging Face Pipeline in LangChain
# llm = HuggingFacePipeline(pipeline=generator)

# # Define Prompt Template for Chatbot Responses
# prompt_template = PromptTemplate(
#     input_variables=["user_input"],
#     template="""
# You are a chatbot assisting users with questions about deep fake detection, AI ethics, legal issues, and technical guidance. Respond in an easy-to-understand, professional manner.
...
#     st.sidebar.text_area("Chatbot:", value=response.strip(), height=150)
...
## button to redirect to sub_code/audio.py 
# Redirect button
